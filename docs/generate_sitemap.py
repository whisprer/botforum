...
def generate_sitemap(base_url, output_file='sitemap.xml', html_dir='.'):
    ...
    Args:
        base_url (str): The base URL of your website (e.g., "https:// botforum.dev/").
...
if __name__ == "__main__":
    ...
    YOUR_BASE_URL = "https://botforum.dev/"
    ...
    # For your setup (HTML files directly in C:\github\botforum or its subfolders):
    # If you run this script from C:\gothub\botforum\, use '.' for html_dir
    # If your HTML files are in C:\github\botforum\public, use 'public'
    
    # Assuming your HTML files are within 'C:\github\botforum'
    # and you will run this script from 'C:\github\botforum'
